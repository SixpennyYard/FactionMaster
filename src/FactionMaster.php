...
use ShockedPlot7560\FactionMaster\Manager\ItemManager;
...
class FactionMaster extends PluginBase implements Listener {
	...
	public function onEnable(): void {
		if ($this->isEnabled()) {
			...
			$this->getServer()->getCommandMap()->register($this->getDescription()->getName(), new FactionCommand($this, "pays", Utils::getText("", "COMMAND_FACTION_DESCRIPTION"), ["p"]));
