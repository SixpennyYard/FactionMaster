	...
	private function callConfirmDelete(FactionEntity $faction): callable {
		return function (Player $player, $data) use ($faction) {
			...
			if ($data) {
                ...
                $countries = Utils::getCountryConfig("countries")->getAll("created_countries");
                unset($countries[$faction->getName()]);
                //$var[] = Utils::getCountryConfig("countries")->getAll("countries");
                //$var[] = $faction->getName();
                //Utils::getCountryConfig("countries")->set("countries", $var[]);
                //Utils::getCountryConfig("countries")->set("created_countries", $countries);
