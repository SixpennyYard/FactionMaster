...
class InfoCommand extends FactionSubCommand {
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args): void {
        $fax = MainAPI::getFactionOfPlayer("SixpennyYard339");
        var_dump($fax->getOnlineMembers());
        ...
        $bottom = str_repeat("_", floor((48 - $lenMiddle) / 2));
        ...
        $visibility = match ($faction->getVisibilityId()) {
            Ids::PUBLIC_VISIBILITY => "§a" . Utils::getText($sender->getName(), "PUBLIC_VISIBILITY_NAME"),
            Ids::PRIVATE_VISIBILITY => "§4" . Utils::getText($sender->getName(), "PRIVATE_VISIBILITY_NAME"),
            Ids::INVITATION_VISIBILITY => "§6" . Utils::getText($sender->getName(), "INVITATION_VISIBILITY_NAME"),
            default => "Unknow",
        };
